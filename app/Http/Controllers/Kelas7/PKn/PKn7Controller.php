...
namespace App\Http\Controllers\Kelas7\PKn;
...
class PKn7Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('kelas7.PKn.index',compact('chapters'));
    ...
    public function showBab(){
        $chapters = Chapter::where([["subject_id", "=", 3], ["grade_id", "=", 1]])->get();
        return view('kelas7.PKn.soal',compact('chapters'));
    ...
    public function create()
    {
        ...
        return view('kelas7.PKn.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelas7.pkn.create')
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kelas7.pkn.soal.tampil')->with('success delete soal');
