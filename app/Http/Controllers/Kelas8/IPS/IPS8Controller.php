...
namespace App\Http\Controllers\Kelas8\IPS;
...
class IPS8Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('kelas8.IPS.index',compact('chapters'));
    ...
    public function showBab(){
        $chapters = Chapter::where([["subject_id", "=", 1], ["grade_id", "=", 2]])->get();
        return view('kelas8.IPS.soal',compact('chapters'));
    ...
    public function create()
    {
        ...
        return view('kelas8.IPS.create', $data);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelas8.ips.create')
    ...
    {
        $bab = Chapter::where([["subject_id", "=", 1], ["grade_id", "=", 2]])->get();

        $dailyTests = DailyTest::where([["subject_id", "=", 1], ["grade_id", "=", 2]])->get();
        return view('kelas8.IPS.show',compact('dailyTests','bab'));
    ...
    public function edit($id)
    {
        ...
        return view('kelas8.IPS.edit', ['dailyTest' => $dailyTest]);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kelas8.ips.soal.tampil')->with('success delete soal');
