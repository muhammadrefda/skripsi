...
namespace App\Http\Controllers\Kelas8\PKn;
...
class PKn8Controller extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('kelas8.PKn.index',compact('chapters'));
    ...
    public function showBab(){
        $chapters = Chapter::where([["subject_id", "=", 3], ["grade_id", "=", 2]])->get();
        return view('kelas8.PKn.soal',compact('chapters'));
    ...
    public function create()
    {
        ...
        return view('kelas8.PKn.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelas8.pkn.create')
    ...
    {
        $bab = Chapter::where([["subject_id", "=", 3], ["grade_id", "=", 2]])->get();

        $dailyTests = DailyTest::where([["subject_id", "=", 3], ["grade_id", "=", 2]])->get();
        return view('kelas8.PKn.show',compact('dailyTests','bab'));
    ...
    public function edit($id)
    {
        ...
        return view('kelas8.PKn.edit', ['dailyTest' => $dailyTest]);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('kelas8.pkn.soal.tampil')->with('success delete soal');
