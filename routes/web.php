...
Route::prefix('kelas-7/penjaskes')->group(function (){
    ...
    Route::get('/soal/ubah/{id}','Kelas7\Penjaskes\Penjaskes7Controller@edit')->name('kelas7.penjas.soal.ubah');
    Route::put('/soal/{id}','Kelas7\Penjaskes\Penjaskes7Controller@update')->name('kelas7.penjas.soal.update');
...
Route::prefix('kelas-7/ipa')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\IPA\IPA7Controller@edit')->name('kelas7.ipa.soal.ubah');
    Route::put('/soal/{id}','Kelas7\IPA\IPA7Controller@update')->name('kelas7.ipa.soal.update');
...
Route::prefix('kelas-7/ips')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\IPS\IPS7Controller@edit')->name('kelas7.ips.soal.ubah');
    Route::put('/soal/{id}','Kelas7\IPS\IPS7Controller@update')->name('kelas7.ips.soal.update');
...
Route::prefix('kelas-7/pai')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\PAI\PAI7Controller@edit')->name('kelas7.pai.soal.ubah');
    Route::put('/soal/{id}','Kelas7\PAI\PAI7Controller@update')->name('kelas7.pai.soal.update');
...
Route::prefix('kelas-7/senibudaya')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\SeniBudaya\SeniBudaya7Controller@edit')->name('kelas7.senibudaya.soal.ubah');
     Route::put('/soal/{id}','Kelas7\SeniBudaya\SeniBudaya7Controller@update')->name('kelas7.senibudaya.soal.update');
...
Route::prefix('kelas-7/BahasaIndonesia')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\BahasaIndonesia\BahasaIndonesia7Controller@edit')->name('kelas7.bind.soal.ubah');
    Route::put('/soal/{id}','Kelas7\BahasaIndonesia\BahasaIndonesia7Controller@update')->name('kelas7.bind.soal.update');
...
Route::prefix('kelas-7/BahasaInggris')->group(function () {
        ...
        Route::get('/soal/ubah/{id}','Kelas7\BahasaInggris\BahasaInggris7Controller@edit')->name('kelas7.bing.soal.ubah');
        Route::put('/soal/{id}','Kelas7\BahasaInggris\BahasaInggris7Controller@update')->name('kelas7.bing.soal.update');
...
Route::prefix('kelas-7/prakarya')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas7\Prakarya\Prakarya7Controller@edit')->name('kelas7.prakarya.soal.ubah');
    Route::put('/soal/{id}','Kelas7\Prakarya\Prakarya7Controller@update')->name('kelas7.prakarya.soal.update');
...
Route::prefix('kelas-7/pkn')->group(function (){
    ...
    Route::get('/soal/ubah/{id}','Kelas7\PKn\PKn7Controller@edit')->name('kelas7.pkn.soal.ubah');
    Route::put('/soal/{id}','Kelas7\PKn\PKn7Controller@update')->name('kelas7.pkn.soal.update');
...
Route::get('/soal/ubah/{id}','Kelas8\Penjaskes\Penjaskes8Controller@edit')->name('kelas8.penjas.soal.ubah');
Route::put('/soal/{id}','Kelas8\Penjaskes\Penjaskes8Controller@update')->name('kelas8.penjas.soal.update');
...
Route::prefix('kelas-8/ipa')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\IPA\IPA8Controller@edit')->name('kelas8.ipa.soal.ubah');
    Route::put('/soal/{id}','Kelas8\IPA\IPA8Controller@update')->name('kelas8.ipa.soal.update');
...
Route::prefix('kelas-8/ips')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\IPS\IPS8Controller@edit')->name('kelas8.ips.soal.ubah');
    Route::put('/soal/{id}','Kelas8\IPS\IPS8Controller@update')->name('kelas8.ips.soal.update');
    Route::get('/soal/tampil', 'Kelas8\IPS\IPS8Controller@show')->name('kelas8.ips.soal.tampil');
    Route::delete('/soal/{id}', 'Kelas8\IPS\IPS8Controller@destroy')->name('kelas8.ips.soal.hapus');
});
...
Route::prefix('kelas-8/pai')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\PAI\PAI8Controller@edit')->name('kelas8.pai.soal.ubah');
    Route::put('/soal/{id}','Kelas8\PAI\PAI8Controller@update')->name('kelas8.pai.soal.update');
...
Route::prefix('kelas-8/senibudaya')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\SeniBudaya\SeniBudaya8Controller@edit')->name('kelas8.senibudaya.soal.ubah');
    Route::put('/soal/{id}','Kelas8\SeniBudaya\SeniBudaya8Controller@update')->name('kelas8.senibudaya.soal.update');
...
Route::prefix('kelas-8/BahasaIndonesia')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\BahasaIndonesia\BahasaIndonesia8Controller@edit')->name('kelas8.bind.soal.ubah');
    Route::put('/soal/{id}','Kelas8\BahasaIndonesia\BahasaIndonesia8Controller@update')->name('kelas8.bind.soal.update');
...
Route::prefix('kelas-8/BahasaInggris')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\BahasaInggris\BahasaInggris8Controller@edit')->name('kelas8.bing.soal.ubah');
    Route::put('/soal/{id}','Kelas8\BahasaInggris\BahasaInggris8Controller@update')->name('kelas8.bing.soal.update');
...
Route::prefix('kelas-8/prakarya')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas8\Prakarya\Prakarya8Controller@edit')->name('kelas8.prakarya.soal.ubah');
    Route::put('/soal/{id}','Kelas8\Prakarya\Prakarya8Controller@update')->name('kelas8.prakarya.soal.update');
...
Route::prefix('kelas-8/pkn')->group(function (){
    ...
    Route::get('/soal/ubah/{id}','Kelas8\PKn\PKn8Controller@edit')->name('kelas8.pkn.soal.ubah');
    Route::put('/soal/{id}','Kelas8\PKn\PKn8Controller@update')->name('kelas8.pkn.soal.update');
...
Route::prefix('kelas-9/penjaskes')->group(function (){
    ...
    Route::get('/soal/ubah/{id}','Kelas9\Penjaskes\Penjaskes9Controller@edit')->name('kelas9.penjas.soal.ubah');
    Route::put('/soal/{id}','Kelas9\Penjaskes\Penjaskes9Controller@update')->name('kelas9.penjas.soal.update');
...
Route::prefix('kelas-9/ipa')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\IPA\IPA9Controller@edit')->name('kelas9.ipa.soal.ubah');
    Route::put('/soal/{id}','Kelas9\IPA\IPA9Controller@update')->name('kelas9.ipa.soal.update');
...
Route::prefix('kelas-9/ips')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\IPS\IPS9Controller@edit')->name('kelas9.ips.soal.ubah');
    Route::put('/soal/{id}','Kelas9\IPS\IPS9Controller@update')->name('kelas9.ips.soal.update');
...
Route::prefix('kelas-9/pai')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\PAI\PAI9Controller@edit')->name('kelas9.pai.soal.ubah');
    Route::put('/soal/{id}','Kelas9\PAI\PAI9Controller@update')->name('kelas9.pai.soal.update');
...
Route::prefix('kelas-9/seni-budaya')->group(function () {
    ...
    Route::get('/soal/tampil', 'Kelas9\SeniBudaya\SeniBudaya9Controller@show')->name('kelas9.senibudaya.soal.tampil');
    Route::get('/soal/ubah/{id}','Kelas9\SeniBudaya\SeniBudaya9Controller@edit')->name('kelas9.senibudaya.soal.ubah');
    Route::put('/soal/{id}','Kelas9\SeniBudaya\SeniBudaya9Controller@update')->name('kelas9.senibudaya.soal.update');

    Route::delete('/soal/{id}', 'Kelas9\SeniBudaya\SeniBudaya9Controller@destroy')->name('kelas9.senibudaya.soal.hapus');
});
...
Route::prefix('kelas-9/Bahasa-indonesia')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\BahasaIndonesia\BahasaIndonesia9Controller@edit')->name('kelas9.bind.soal.ubah');
    Route::put('/soal/{id}','Kelas9\BahasaIndonesia\BahasaIndonesia9Controller@update')->name('kelas9.bind.soal.update');
...
Route::prefix('kelas-9/Bahasa-inggris')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\BahasaInggris\BahasaInggris9Controller@edit')->name('kelas9.bing.soal.ubah');
    Route::put('/soal/{id}','Kelas9\BahasaInggris\BahasaInggris9Controller@update')->name('kelas9.bing.soal.update');
...
Route::prefix('kelas-9/prakarya')->group(function () {
    ...
    Route::get('/soal/ubah/{id}','Kelas9\Prakarya\Prakarya9Controller@edit')->name('kelas9.prakarya.soal.ubah');
    Route::put('/soal/{id}','Kelas9\Prakarya\Prakarya9Controller@update')->name('kelas9.prakarya.soal.update');
...
Route::prefix('kelas-9/pkn')->group(function (){
    ...
    Route::get('/soal/ubah/{id}','Kelas9\PKn\PKn9Controller@edit')->name('kelas9.pkn.soal.ubah');
    Route::put('/soal/{id}','Kelas9\PKn\PKn9Controller@update')->name('kelas9.pkn.soal.update');
